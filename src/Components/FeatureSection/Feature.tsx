                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      <g id="Group">
                        <path
                          id="Vector"
                          d="M4.33325 0.333374H29.6666L25.6666 8.33337H0.333252L4.33325 0.333374Z"
                          fill="#7C3AED"
                        />
                        <path
                          id="Vector_2"
                          d="M4.33325 11.0001H29.6666L25.6666 19.0001H0.333252L4.33325 11.0001Z"
                          fill="#1DB5BE"
                        />
                        <path
                          id="Vector_3"
                          d="M4.33325 21.6667H29.6666L25.6666 29.6667H0.333252L4.33325 21.6667Z"
                          fill="#C4B5FD"
                        />
                      </g>
                    </svg>
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      <g id="Group">
                        <path
                          id="Vector"
                          d="M29.6667 7.00004V1.66671C29.6667 1.31309 29.5262 0.973946 29.2762 0.723897C29.0261 0.473849 28.687 0.333374 28.3334 0.333374H1.66671C1.31309 0.333374 0.973946 0.473849 0.723897 0.723897C0.473849 0.973946 0.333374 1.31309 0.333374 1.66671V7.00004H29.6667Z"
                          fill="#1DB5BE"
                        />
                        <path
                          id="Vector_2"
                          d="M0.333374 9.66675V28.3334C0.333374 28.687 0.473849 29.0262 0.723897 29.2762C0.973946 29.5263 1.31309 29.6667 1.66671 29.6667H8.33337V9.66675H0.333374Z"
                          fill="#C4B5FD"
                        />
                        <path
                          id="Vector_3"
                          d="M11 29.6667H28.3333C28.687 29.6667 29.0261 29.5263 29.2761 29.2762C29.5262 29.0262 29.6667 28.687 29.6667 28.3334V9.66675H11V29.6667Z"
                          fill="#7C3AED"
                        />
                      </g>
                    </svg>
          ...
          <div className="lg:mx-[112px] lg:mt-[24px]  mx-[40px] mt-[40px">
            <div className="grid grid-cols-3 gap-3 mx-5 pb-10 mb-10">
              <div className="max-w-sm  overflow-hidden shadow-lg rounded  dark:bg-slate-800">
                ...
                <div>
                  <progress
                    className="progress progress-primary w-56 ml-3"
                    value="40"
                    max="100"
                  />
                </div>
