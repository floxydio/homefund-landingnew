        ...
        <>
            ...
            <div className="lg:hidden lg:mt-[30px] lg:h-[640px] flex-row justify-between">
                <div className="div mt-[100px] w-full">
                    ...
                    <p className="text-[18px] mt-[10px] w-full">From the small stuff to the big picture, organizes the work<br />so teams know what to do, why it matters, and how to get it done.</p>
